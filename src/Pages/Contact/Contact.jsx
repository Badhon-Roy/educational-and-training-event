        ...
        <div>
            ...
            <div className='bg-white my-8 md:p-16 p-8 shadow-lg rounded'>
                ...
                <form>
                    ...
                    <button className="btn transform translate-x-0 transition-transform ease-in-out  px-8 duration-300 hover:translate-x-5 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold py-2 hover:from-green-500 hover:to-blue-500">Submit</button>
                </form>
            </div>
